...
An interesting application to note is the **jmx-console** application that is packaged within JBoss. This application kind of does what we want to do. It displays all the MBeans deployed on the server.
...
Final screen -
!["Queue"](http://rockysjavacafe.wordpress.com/files/2009/11/qbrowser2.png)
...
**Credits** - JBoss team for providing the source to JMX Console, which helped us get started and <a href="http://www-scf.usc.edu/~meghaj/">Megha Jain </a> my colleague for working with me on this exercise.
